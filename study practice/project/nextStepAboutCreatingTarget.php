...
<body>
    ...
    <dialog id="creatingTarget">
        <article>
            <p>Начнем с простого.</p>
            <p><b>Какую цель должен</b> исполнить проект?</p>
        </article>
        <form action="targetCreating.php" method="post">
            <input type="text" placeholder="Цель" name="targetName" required>
            <button id="continueAfterCreatingTarget">Продолжить</button>
        </form>
    </dialog>
